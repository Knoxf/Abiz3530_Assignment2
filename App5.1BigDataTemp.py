...
# filter rows for temperature < 62.1
less_than_622 = df[temp_is_too_low]
print(less_than_622.shape)

# print the first 4 rows for temperature < 62.1
...
# filter rows for temperature > 79.7
greater_than_796 = df[temp_is_too_high]
print(greater_than_796.shape)

# print the first 4 rows for temperature > 79.7
