...
x1 = LpVariable("WHT", 220, None, LpInteger)
x2 = LpVariable("CRN", 190)
x3 = LpVariable("BAR", 190)
x4 = LpVariable("SBM", 360)
x5 = LpVariable("PRE", 1800)
x6 = LpVariable("LYS", 1950)

prob += 220 * x1 + 190 * x2 + 190 * x3 + 360 * x4 + 1450 * x5 + 1800 * x6, "RationCost"
